    ...
    <>
      <div className="flex flex-col items-center p-15">
        <div className="flex justify-between w-84">
          <button class="admin_customer" onClick={() => setIsAdmin(true)}>
            <svg
              height="36px"
              width="36px"
              viewBox="0 0 36 36"
            ...
            <span class="now">Hello!</span>
            <span class="play">Adminn </span>
          </button>

          <button class="admin_customer" onClick={() => setIsAdmin(false)}>
            <svg
              height="36px"
              width="36px"
              viewBox="0 0 36 36"
        ...
        {isAdmin ? (
          <div class="login-box">
            ...
            <p className="text-center text-gray-400 font-bold ">Credentials:</p>
